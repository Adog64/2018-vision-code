...
public class Main {
    public static void main(String[] args) {
        ...
        public static final String ROOT = "Vision";
        ...
        public static final int STREAMPORT = 1186;

        // This stores our reference to our mjpeg server for streaming the input image
        MjpegServer lifecamOutputStream = new MjpegServer("Lifecam_Output_Stream", STREAMPORT);

        //Our CvSource
        CvSource lifecamSource = new CvSource("piSource", VideoMode.PixelFormat.kMJPEG, Res_X, Res_Y, FPS);
